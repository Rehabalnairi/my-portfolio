  ...
  const cards: Card[] = [
    {
      ...
      emoji: "💡",
      content: (
        <div className="bg-[#0F172A]/50 backdrop-blur-md rounded-xl p-4 max-w-xs">
      ...
      content: (
        <div className="flex flex-wrap gap-1">
          {[
            ...
            <span
              key={project}
              className="bg-[#FACC15]/20 text-[#FACC15] px-2 py-1 rounded-full text-xs font-semibold"
            >
              {project}
            </span>
          ))}
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col gap-2 max-h-60 overflow-hidden"> {/* هنا overflow-hidden لإخفاء السكولر */}
          ...
          <div>
            <h3 className="text-[#FACC15] font-semibold mb-1">Backend</h3>
            <div className="flex flex-wrap gap-1">
          ...
          <div>
            <h3 className="text-[#FACC15] font-semibold mb-1">Tools & Others</h3>
            <div className="flex flex-wrap gap-1">
      ...
      content: (
        <div className="flex flex-col gap-1">
          <a
            ...
            target="_blank"
            className="hover:text-[#FACC15] flex items-center gap-1"
          >
            🔗 LinkedIn
          </a>
          <a
  ...
  return (
    ...
    >
      {cards.map((card, i) => (
        ...
        >
          <button className="w-10 h-10 sm:w-14 sm:h-14 bg-[#FACC15]/90 text-black rounded-full shadow-lg font-bold text-base sm:text-lg transition hover:scale-110">
            {card.emoji}
          </button>
